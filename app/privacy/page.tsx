    ...
    <div className="min-h-screen py-16 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-8 text-muted-foreground leading-relaxed">
          ...
          <p><strong>Company Name:</strong> KG Components</p>
          <p><strong>Registered Office:</strong> 137 Cassava Residencial, Via Expressa, Luanda, Angola</p>
          <p><strong>Contact Email:</strong> orders@kg-compponents.com</p>
          <p><strong>Contact Number:</strong> +244923054613, +244921191402</p>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-1">
              <li><strong>Identification Data:</strong> Full name, national ID number (for pickup verification, if
              applicable).</li>
              <li><strong>Contact Details:</strong> Phone number, email address, and where applicable, physical
              address.</li>
              <li><strong>Order Information:</strong> Products ordered, order history, reference numbers for
              payments.</li>
              <li><strong>Payment Reference Data:</strong> Information required to verify offline payment via
              references.</li>
              <li><strong>Technical Data:</strong> IP address, browser information, device type, and activity logs.</li>
              <li><strong>User Correspondence:</strong> Inquiries, feedback, or customer service communications.</li>
            </ul>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4">3. PURPOSES FOR DATA COLLECTION</h2>
            ...
            <ul className="list-disc list-inside space-y-1">
              ...
              <li>To improve operational efficiency, platform usability, and overall user
              experience.</li>
              <li>To comply with legal obligations, including anti-fraud and regulatory
              requirements.</li>
              <li>To send service-related communications, such as updates or important
              notifications.</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>We rely on the following lawful bases for processing your data:</p>
            <ul className="list-disc list-inside space-y-1">
              <li><strong>Consent:</strong> Where we seek your explicit agreement (e.g., marketing).</li>
              <li><strong>Contractual Necessity:</strong> To fulfill our obligations arising from any agreements with
              you.</li>
              <li><strong>Legal Obligation:</strong> Where processing is necessary to comply with applicable laws.</li>
              <li><strong>Legitimate Interests:</strong> To manage and improve our operations and services.</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>We may share your data with the following third parties, only to the extent necessary:</p>
            <ul className="list-disc list-inside space-y-1">
              <li><strong>Suppliers and Service Providers:</strong> Who assist in logistics, order fulfillment, IT
              services, and customer support, under strict confidentiality obligations.</li>
              <li><strong>Regulatory and Legal Authorities:</strong> Where required by applicable law, legal
              process, or court order.</li>
              <li><strong>Successors:</strong> In the event of a merger, acquisition, restructuring, or sale of assets,
          ...
          <section>
            ...
            <p>You may have the following rights under applicable data protection laws:</p>
            <ul className="list-disc list-inside space-y-1">
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4">13. DATA CONTROLLER AND DATA PROCESSORS</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4">14. RECORD OF PROCESSING ACTIVITIES</h2>
            <p>
              We maintain a comprehensive internal record of all data processing activities, including
              the types of personal data collected, purposes, legal bases, retention periods, and third-
              party disclosures. These records support our commitment to transparency and
              accountability.
            </p>
          </section>
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4">16. CONSENT AND POLICY UPDATES</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4">17. Governing Law And Jurisdiction</h2>
            <p>
          ...
          <section>
            ...
            <p>orders@kg-compponents.com</p>
            <p>137 Cassava Residencial, Via Expressa, Luanda, Angola</p>
            <p>Email: orders@kg-compponents.com</p>
            <p>Phone: +244923054613, +244921191202</p>
          </section>
        </div>
      </div>
    </div>
